...
In this GitHub repository, we present the implementation of our `VAEAC` and `[equation](https://latex.codecogs.com/svg.latex?p(\texttt{VAEAC}_\mathcal{C}))` approaches to Shapley value estimation from our paper "Using Shapley Values and Variational Autoencoders to Explain Predictive Models with Dependent Mixed Features", see [Olsen et al. (2022)](https://arxiv.org/abs/2111.13507). 
